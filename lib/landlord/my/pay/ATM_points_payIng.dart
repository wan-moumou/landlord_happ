...
class ATMPointsPayIng extends StatefulWidget {
  final buyNum;
  final money;
  final points;

  ATMPointsPayIng({this.money, this.buyNum, this.points});

  @override
  _ATMPointsPayIngState createState() => _ATMPointsPayIngState();
}

class _ATMPointsPayIngState extends State<ATMPointsPayIng> {
  String loginUser = '';
                          ...
                          Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                ...
                                style: TextStyle(
                                  color: check ? Colors.black54 : Colors.red,
                                ),
                              )),
                            ],
                          ),
